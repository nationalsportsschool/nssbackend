...
export const getStudentAttendance = async (
  ...
  try {
    console.log('🎯 GET /api/attendance/students - Query:', req.query);
...
export const getCoachAttendance = async (
  ...
  try {
    console.log('🎯 GET /api/attendance/coaches - Query:', req.query);
    const { startDate, endDate } = req.query;
    ...
    console.log('✅ Coach attendance retrieved -', attendance?.length || 0, 'records');
